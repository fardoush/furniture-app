  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center space-y-2 md:space-y-4 px-4">
        <h1 className="text-3xl md:text-5xl font-bold text-black tracking-wide">Shop</h1>
        ...
        <div className="flex items-center gap-1 md:gap-2 text-sm md:text-base">
          ...
          <ChevronRight size={18} className="text-black font-bold" /> <Link to="/shop" className="text-black font-light">Shop</Link>
        </div>
      </div>
    </div>
  );
